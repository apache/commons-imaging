...
{ /**/
	public static final TagInfo2 EXIF_TAG_INTEROP_INDEX = new TagInfo2(
			"Interop Index", 0x0001, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_INTEROP_IFD);
	public static final TagInfo2 EXIF_TAG_INTEROP_VERSION = new TagInfo2(
			"Interop Version", 0x0002, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_INTEROP_IFD);
	public static final TagInfo2 EXIF_TAG_PROCESSING_SOFTWARE = new TagInfo2(
			"Processing Software", 0x000b, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_SUBFILE_TYPE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_OLD_SUBFILE_TYPE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_IMAGE_WIDTH_IFD0 = new TagInfo2(
			"Image Width", 0x0100, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_IMAGE_HEIGHT_IFD0 = new TagInfo2(
			"Image Height", 0x0101, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_BITS_PER_SAMPLE = new TagInfo2(
			"Bits Per Sample", 0x0102, FIELD_TYPE_SHORT, -1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_COMPRESSION = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_PHOTOMETRIC_INTERPRETATION = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_THRESHOLDING = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_CELL_WIDTH = new TagInfo2(
			"Cell Width", 0x0108, FIELD_TYPE_SHORT, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_CELL_LENGTH = new TagInfo2(
			"Cell Length", 0x0109, FIELD_TYPE_SHORT, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_FILL_ORDER = new TagInfo2(
			"Fill Order", 0x010a, FIELD_TYPE_SHORT, 1, EXIF_DIRECTORY_IFD0);
	// tag constants public static final int FILL_ORDER_VALUE_NORMAL = 1;
	public static final int FILL_ORDER_VALUE_REVERSED = 2;
	public static final TagInfo2 EXIF_TAG_DOCUMENT_NAME = new TagInfo2(
			"Document Name", 0x010d, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_IMAGE_DESCRIPTION = new TagInfo2(
			"Image Description", 0x010e, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_MAKE = new TagInfo2("Make", 0x010f,
			FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_MODEL = new TagInfo2("Model", 0x0110,
			FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	...
	public static final TagInfo2 EXIF_TAG_PREVIEW_IMAGE_START_IFD0 = new TagInfo2(
			"Preview Image Start", 0x0111, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_PREVIEW_IMAGE_START_SUB_IFD1 = new TagInfo2(
			"Preview Image Start", 0x0111, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_SUB_IFD1);
	public static final TagInfo2 EXIF_TAG_JPG_FROM_RAW_START_SUB_IFD2 = new TagInfo2(
			"Jpg From Raw Start", 0x0111, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_SUB_IFD2);
	public static final TagInfo2 EXIF_TAG_ORIENTATION = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_SAMPLES_PER_PIXEL = new TagInfo2(
			"Samples Per Pixel", 0x0115, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_ROWS_PER_STRIP = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_PREVIEW_IMAGE_LENGTH_IFD0 = new TagInfo2(
			"Preview Image Length", 0x0117, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_PREVIEW_IMAGE_LENGTH_SUB_IFD1 = new TagInfo2(
			"Preview Image Length", 0x0117, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_SUB_IFD1);
	public static final TagInfo2 EXIF_TAG_JPG_FROM_RAW_LENGTH_SUB_IFD2 = new TagInfo2(
			"Jpg From Raw Length", 0x0117, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_SUB_IFD2);
	public static final TagInfo2 EXIF_TAG_MIN_SAMPLE_VALUE = new TagInfo2(
			"Min Sample Value", 0x0118, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_MAX_SAMPLE_VALUE = new TagInfo2(
			"Max Sample Value", 0x0119, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_XRESOLUTION = new TagInfo2(
			"XResolution", 0x011a, FIELD_TYPE_RATIONAL, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_YRESOLUTION = new TagInfo2(
			"YResolution", 0x011b, FIELD_TYPE_RATIONAL, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_PLANAR_CONFIGURATION = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_PAGE_NAME = new TagInfo2("Page Name",
			0x011d, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_XPOSITION = new TagInfo2("XPosition",
			0x011e, FIELD_TYPE_RATIONAL, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_YPOSITION = new TagInfo2("YPosition",
			0x011f, FIELD_TYPE_RATIONAL, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_FREE_OFFSETS = new TagInfo2(
			"Free Offsets", 0x0120, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_FREE_BYTE_COUNTS = new TagInfo2(
			"Free Byte Counts", 0x0121, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_GRAY_RESPONSE_UNIT = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_GRAY_RESPONSE_CURVE = new TagInfo2(
			"Gray Response Curve", 0x0123, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_T4OPTIONS = new TagInfo2(
			"T4 Options", 0x0124, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_T6OPTIONS = new TagInfo2(
			"T6 Options", 0x0125, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_RESOLUTION_UNIT = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_PAGE_NUMBER = new TagInfo2(
			"Page Number", 0x0129, FIELD_TYPE_SHORT, 2, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_COLOR_RESPONSE_UNIT = new TagInfo2(
			"Color Response Unit", 0x012c, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_TRANSFER_FUNCTION = new TagInfo2(
			"Transfer Function", 0x012d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SOFTWARE = new TagInfo2("Software",
			0x0131, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_MODIFY_DATE = new TagInfo2(
			"Modify Date", 0x0132, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_ARTIST = new TagInfo2("Artist",
			0x013b, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_HOST_COMPUTER = new TagInfo2(
			"Host Computer", 0x013c, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_PREDICTOR = new TagInfo2("Predictor",
	...
	public static final TagInfo2 EXIF_TAG_WHITE_POINT = new TagInfo2(
			"White Point", 0x013e, FIELD_TYPE_RATIONAL, 2, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_PRIMARY_CHROMATICITIES = new TagInfo2(
			"Primary Chromaticities", 0x013f, FIELD_TYPE_RATIONAL, 6,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_COLOR_MAP = new TagInfo2("Color Map",
			0x0140, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_HALFTONE_HINTS = new TagInfo2(
			"Halftone Hints", 0x0141, FIELD_TYPE_SHORT, 2, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_TILE_WIDTH = new TagInfo2(
			"Tile Width", 0x0142, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_TILE_LENGTH = new TagInfo2(
			"Tile Length", 0x0143, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_TILE_OFFSETS = new TagInfo2(
			"Tile Offsets", 0x0144, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_TILE_BYTE_COUNTS = new TagInfo2(
			"Tile Byte Counts", 0x0145, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BAD_FAX_LINES = new TagInfo2(
			"Bad Fax Lines", 0x0146, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CLEAN_FAX_DATA = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_CONSECUTIVE_BAD_FAX_LINES = new TagInfo2(
			"Consecutive Bad Fax Lines", 0x0148,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SUB_IFD = new TagInfo2("Sub IFD",
			0x014a, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_INK_SET = new TagInfo2("Ink Set",
	...
	public static final TagInfo2 EXIF_TAG_INK_NAMES = new TagInfo2("Ink Names",
			0x014d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_NUMBEROF_INKS = new TagInfo2(
			"Numberof Inks", 0x014e, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_DOT_RANGE = new TagInfo2("Dot Range",
			0x0150, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_TARGET_PRINTER = new TagInfo2(
			"Target Printer", 0x0151, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_EXTRA_SAMPLES = new TagInfo2(
			"Extra Samples", 0x0152, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SAMPLE_FORMAT = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_SMIN_SAMPLE_VALUE = new TagInfo2(
			"SMin Sample Value", 0x0154, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SMAX_SAMPLE_VALUE = new TagInfo2(
			"SMax Sample Value", 0x0155, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_TRANSFER_RANGE = new TagInfo2(
			"Transfer Range", 0x0156, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CLIP_PATH = new TagInfo2("Clip Path",
			0x0157, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_XCLIP_PATH_UNITS = new TagInfo2(
			"XClip Path Units", 0x0158, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_YCLIP_PATH_UNITS = new TagInfo2(
			"YClip Path Units", 0x0159, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_INDEXED = new TagInfo2("Indexed",
	...
	public static final TagInfo2 EXIF_TAG_JPEGTABLES = new TagInfo2(
			"JPEGTables", 0x015b, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_OPIPROXY = new TagInfo2("OPIProxy",
	...
	public static final TagInfo2 EXIF_TAG_GLOBAL_PARAMETERS_IFD = new TagInfo2(
			"Global Parameters IFD", 0x0190, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_PROFILE_TYPE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_FAX_PROFILE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_CODING_METHODS = new TagInfo2(
			"Coding Methods", 0x0193, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_VERSION_YEAR = new TagInfo2(
			"Version Year", 0x0194, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MODE_NUMBER = new TagInfo2(
			"Mode Number", 0x0195, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_DECODE = new TagInfo2("Decode",
			0x01b1, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_DEFAULT_IMAGE_COLOR = new TagInfo2(
			"Default Image Color", 0x01b2, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_JPEGPROC = new TagInfo2("JPEGProc",
	...
	public static final TagInfo2 EXIF_TAG_PREVIEW_IMAGE_START_MAKER_NOTES = new TagInfo2(
			"Preview Image Start", 0x0201, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_MAKER_NOTES);
	public static final TagInfo2 EXIF_TAG_JPG_FROM_RAW_START_SUB_IFD = new TagInfo2(
			"Jpg From Raw Start", 0x0201, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_JPG_FROM_RAW_START_IFD2 = new TagInfo2(
			"Jpg From Raw Start", 0x0201, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_IFD2);
	public static final TagInfo2 EXIF_TAG_OTHER_IMAGE_START = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_PREVIEW_IMAGE_LENGTH_MAKER_NOTES = new TagInfo2(
			"Preview Image Length", 0x0202, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_MAKER_NOTES);
	public static final TagInfo2 EXIF_TAG_JPG_FROM_RAW_LENGTH_SUB_IFD = new TagInfo2(
			"Jpg From Raw Length", 0x0202, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_JPG_FROM_RAW_LENGTH_IFD2 = new TagInfo2(
			"Jpg From Raw Length", 0x0202, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_IFD2);
	public static final TagInfo2 EXIF_TAG_OTHER_IMAGE_LENGTH = new TagInfo2(
			"Other Image Length", 0x0202, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_JPEGRESTART_INTERVAL = new TagInfo2(
			"JPEGRestart Interval", 0x0203, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_JPEGLOSSLESS_PREDICTORS = new TagInfo2(
			"JPEGLossless Predictors", 0x0205, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_JPEGPOINT_TRANSFORMS = new TagInfo2(
			"JPEGPoint Transforms", 0x0206, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_JPEGQTABLES = new TagInfo2(
			"JPEGQTables", 0x0207, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_JPEGDCTABLES = new TagInfo2(
			"JPEGDCTables", 0x0208, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_JPEGACTABLES = new TagInfo2(
			"JPEGACTables", 0x0209, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_YCBCR_COEFFICIENTS = new TagInfo2(
			"YCbCr Coefficients", 0x0211, FIELD_TYPE_RATIONAL, 3,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_YCBCR_SUB_SAMPLING = new TagInfo2(
			"YCbCr Sub Sampling", 0x0212, FIELD_TYPE_SHORT, 2,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_YCBCR_POSITIONING = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_REFERENCE_BLACK_WHITE = new TagInfo2(
			"Reference Black White", 0x0214, FIELD_TYPE_RATIONAL, 6,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_STRIP_ROW_COUNTS = new TagInfo2(
			"Strip Row Counts", 0x022f, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_APPLICATION_NOTES = new TagInfo2(
			"Application Notes", 0x02bc, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_RELATED_IMAGE_FILE_FORMAT = new TagInfo2(
			"Related Image File Format", 0x1000, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_INTEROP_IFD);
	public static final TagInfo2 EXIF_TAG_RELATED_IMAGE_WIDTH = new TagInfo2(
			"Related Image Width", 0x1001, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_INTEROP_IFD);
	public static final TagInfo2 EXIF_TAG_RELATED_IMAGE_LENGTH = new TagInfo2(
			"Related Image Length", 0x1002, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_INTEROP_IFD);
	public static final TagInfo2 EXIF_TAG_RATING = new TagInfo2("Rating",
			0x4746, FIELD_TYPE_SHORT, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_RATING_PERCENT = new TagInfo2(
			"Rating Percent", 0x4749, FIELD_TYPE_SHORT, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_IMAGE_ID = new TagInfo2("Image ID",
			0x800d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_WANG_ANNOTATION = new TagInfo2(
			"Wang Annotation", 0x80a4, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MATTEING = new TagInfo2("Matteing",
			0x80e3, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_DATA_TYPE = new TagInfo2("Data Type",
			0x80e4, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_DEPTH = new TagInfo2(
			"Image Depth", 0x80e5, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_TILE_DEPTH = new TagInfo2(
			"Tile Depth", 0x80e6, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MODEL_2 = new TagInfo2("Model 2",
			0x827d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CFAREPEAT_PATTERN_DIM = new TagInfo2(
			"CFARepeat Pattern Dim", 0x828d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CFAPATTERN_2 = new TagInfo2(
			"CFAPattern 2", 0x828e, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BATTERY_LEVEL = new TagInfo2(
			"Battery Level", 0x828f, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_COPYRIGHT = new TagInfo2("Copyright",
			0x8298, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_EXPOSURE_TIME = new TagInfo2(
			"Exposure Time", 0x829a, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_FNUMBER = new TagInfo2("FNumber",
			0x829d, FIELD_TYPE_RATIONAL, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_MDFILE_TAG = new TagInfo2(
			"MDFile Tag", 0x82a5, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MDSCALE_PIXEL = new TagInfo2(
			"MDScale Pixel", 0x82a6, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MDCOLOR_TABLE = new TagInfo2(
			"MDColor Table", 0x82a7, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MDLAB_NAME = new TagInfo2(
			"MDLab Name", 0x82a8, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MDSAMPLE_INFO = new TagInfo2(
			"MDSample Info", 0x82a9, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MDPREP_DATE = new TagInfo2(
			"MDPrep Date", 0x82aa, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MDPREP_TIME = new TagInfo2(
			"MDPrep Time", 0x82ab, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MDFILE_UNITS = new TagInfo2(
			"MDFile Units", 0x82ac, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_PIXEL_SCALE = new TagInfo2(
			"Pixel Scale", 0x830e, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IPTC_NAA = new TagInfo2("IPTC- NAA",
			0x83bb, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_INTERGRAPH_PACKET_DATA = new TagInfo2(
			"Intergraph Packet Data", 0x847e, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_INTERGRAPH_FLAG_REGISTERS = new TagInfo2(
			"Intergraph Flag Registers", 0x847f,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_INTERGRAPH_MATRIX = new TagInfo2(
			"Intergraph Matrix", 0x8480, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MODEL_TIE_POINT = new TagInfo2(
			"Model Tie Point", 0x8482, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SITE = new TagInfo2("Site", 0x84e0,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_COLOR_SEQUENCE = new TagInfo2(
			"Color Sequence", 0x84e1, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IT8HEADER = new TagInfo2(
			"IT8 Header", 0x84e2, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_RASTER_PADDING = new TagInfo2(
			"Raster Padding", 0x84e3, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BITS_PER_RUN_LENGTH = new TagInfo2(
			"Bits Per Run Length", 0x84e4, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BITS_PER_EXTENDED_RUN_LENGTH = new TagInfo2(
			"Bits Per Extended Run Length", 0x84e5,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_COLOR_TABLE = new TagInfo2(
			"Color Table", 0x84e6, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_COLOR_INDICATOR = new TagInfo2(
			"Image Color Indicator", 0x84e7, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BACKGROUND_COLOR_INDICATOR = new TagInfo2(
			"Background Color Indicator", 0x84e8,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_COLOR_VALUE = new TagInfo2(
			"Image Color Value", 0x84e9, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BACKGROUND_COLOR_VALUE = new TagInfo2(
			"Background Color Value", 0x84ea, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_PIXEL_INTENSITY_RANGE = new TagInfo2(
			"Pixel Intensity Range", 0x84eb, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_TRANSPARENCY_INDICATOR = new TagInfo2(
			"Transparency Indicator", 0x84ec, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_COLOR_CHARACTERIZATION = new TagInfo2(
			"Color Characterization", 0x84ed, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_HCUSAGE = new TagInfo2("HCUsage",
			0x84ee, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SEMINFO = new TagInfo2("SEMInfo",
			0x8546, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_AFCP_IPTC = new TagInfo2(
			"AFCP_ IPTC", 0x8568, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MODEL_TRANSFORM = new TagInfo2(
			"Model Transform", 0x85d8, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_LEAF_DATA = new TagInfo2("Leaf Data",
	...
	public static final TagInfo2 EXIF_TAG_ICC_PROFILE = new TagInfo2(
			...
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_LAYER = new TagInfo2(
			"Image Layer", 0x87ac, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_GEO_TIFF_DIRECTORY = new TagInfo2(
			"Geo Tiff Directory", 0x87af, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_GEO_TIFF_DOUBLE_PARAMS = new TagInfo2(
			"Geo Tiff Double Params", 0x87b0, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_GEO_TIFF_ASCII_PARAMS = new TagInfo2(
			"Geo Tiff Ascii Params", 0x87b1, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_EXPOSURE_PROGRAM = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_OPTO__ELECTRIC_CONV_FACTOR = new TagInfo2(
			"Opto - Electric Conv Factor", 0x8828,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_INTERLACE = new TagInfo2("Interlace",
			0x8829, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_TIME_ZONE_OFFSET = new TagInfo2(
			"Time Zone Offset", 0x882a, FIELD_TYPE_SSHORT, -1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SELF_TIMER_MODE = new TagInfo2(
			"Self Timer Mode", 0x882b, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_FAX_RECV_PARAMS = new TagInfo2(
			"Fax Recv Params", 0x885c, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_FAX_SUB_ADDRESS = new TagInfo2(
			"Fax Sub Address", 0x885d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_FAX_RECV_TIME = new TagInfo2(
			"Fax Recv Time", 0x885e, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_LEAF_SUB_IFD = new TagInfo2(
			"Leaf Sub IFD", 0x888a, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_EXIF_VERSION = new TagInfo2(
			"Exif Version", 0x9000, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_DATE_TIME_ORIGINAL = new TagInfo2(
			"Date Time Original", 0x9003, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_CREATE_DATE = new TagInfo2(
			"Create Date", 0x9004, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_COMPONENTS_CONFIGURATION = new TagInfo2(
			"Components Configuration", 0x9101, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_COMPRESSED_BITS_PER_PIXEL = new TagInfo2(
			"Compressed Bits Per Pixel", 0x9102, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SHUTTER_SPEED_VALUE = new TagInfo2(
			"Shutter Speed Value", 0x9201, FIELD_TYPE_SRATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_APERTURE_VALUE = new TagInfo2(
			"Aperture Value", 0x9202, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_BRIGHTNESS_VALUE = new TagInfo2(
			"Brightness Value", 0x9203, FIELD_TYPE_SRATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_EXPOSURE_COMPENSATION = new TagInfo2(
			"Exposure Compensation", 0x9204, FIELD_TYPE_SRATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_MAX_APERTURE_VALUE = new TagInfo2(
			"Max Aperture Value", 0x9205, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SUBJECT_DISTANCE = new TagInfo2(
			"Subject Distance", 0x9206, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_METERING_MODE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_LIGHT_SOURCE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_FLASH = new TagInfo2("Flash", 0x9209,
			FIELD_TYPE_SHORT, 1, EXIF_DIRECTORY_EXIF_IFD);
	...
	public static final TagInfo2 EXIF_TAG_FOCAL_LENGTH = new TagInfo2(
			"Focal Length", 0x920a, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_FLASH_ENERGY = new TagInfo2(
			"Flash Energy", 0x920b, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SPATIAL_FREQUENCY_RESPONSE_1 = new TagInfo2(
			"Spatial Frequency Response", 0x920c,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_NOISE_1 = new TagInfo2("Noise",
			0x920d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_FOCAL_PLANE_XRESOLUTION = new TagInfo2(
			"Focal Plane XResolution", 0x920e, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_FOCAL_PLANE_YRESOLUTION = new TagInfo2(
			"Focal Plane YResolution", 0x920f, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_FOCAL_PLANE_RESOLUTION_UNIT = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_IMAGE_NUMBER_EXIF_IFD = new TagInfo2(
			"Image Number", 0x9211, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SECURITY_CLASSIFICATION_EXIF_IFD = new TagInfo2(
			"Security Classification", 0x9212, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_IMAGE_HISTORY_EXIF_IFD = new TagInfo2(
			"Image History", 0x9213, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SUBJECT_LOCATION_1 = new TagInfo2(
			"Subject Location", 0x9214, FIELD_TYPE_SHORT, 4,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_EXPOSURE_INDEX = new TagInfo2(
			"Exposure Index", 0x9215, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_TIFF_EPSTANDARD_ID_1 = new TagInfo2(
			"TIFF- EPStandard ID", 0x9216, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SENSING_METHOD = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_STO_NITS = new TagInfo2("Sto Nits",
	...
	public static final TagInfo2 EXIF_TAG_SUB_SEC_TIME = new TagInfo2(
			"Sub Sec Time", 0x9290, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SUB_SEC_TIME_ORIGINAL = new TagInfo2(
			"Sub Sec Time Original", 0x9291, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SUB_SEC_TIME_DIGITIZED = new TagInfo2(
			"Sub Sec Time Digitized", 0x9292, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_IMAGE_SOURCE_DATA = new TagInfo2(
			"Image Source Data", 0x935c, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_XPTITLE = new TagInfo2("XPTitle",
			0x9c9b, FIELD_TYPE_BYTE, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_XPCOMMENT = new TagInfo2("XPComment",
			0x9c9c, FIELD_TYPE_BYTE, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_XPAUTHOR = new TagInfo2("XPAuthor",
			0x9c9d, FIELD_TYPE_BYTE, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_XPKEYWORDS = new TagInfo2(
			"XPKeywords", 0x9c9e, FIELD_TYPE_BYTE, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_XPSUBJECT = new TagInfo2("XPSubject",
			0x9c9f, FIELD_TYPE_BYTE, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_FLASHPIX_VERSION = new TagInfo2(
			"Flashpix Version", 0xa000, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_COLOR_SPACE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_EXIF_IMAGE_WIDTH = new TagInfo2(
			"Exif Image Width", 0xa002, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_EXIF_IMAGE_LENGTH = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_FLASH_ENERGY_EXIF_IFD = new TagInfo2(
			...
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SPATIAL_FREQUENCY_RESPONSE_2 = new TagInfo2(
			"Spatial Frequency Response", 0xa20c,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_NOISE_2 = new TagInfo2("Noise",
			0xa20d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_FOCAL_PLANE_XRESOLUTION_EXIF_IFD = new TagInfo2(
			"Focal Plane XResolution", 0xa20e, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_FOCAL_PLANE_YRESOLUTION_EXIF_IFD = new TagInfo2(
			"Focal Plane YResolution", 0xa20f, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_FOCAL_PLANE_RESOLUTION_UNIT_EXIF_IFD = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_IMAGE_NUMBER = new TagInfo2(
			"Image Number", 0xa211, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SECURITY_CLASSIFICATION = new TagInfo2(
			"Security Classification", 0xa212, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_HISTORY = new TagInfo2(
			"Image History", 0xa213, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SUBJECT_LOCATION_2 = new TagInfo2(
			"Subject Location", 0xa214, FIELD_TYPE_SHORT, 2,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_EXPOSURE_INDEX_EXIF_IFD = new TagInfo2(
			"Exposure Index", 0xa215, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_TIFF_EPSTANDARD_ID_2 = new TagInfo2(
			"TIFF- EPStandard ID", 0xa216, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SENSING_METHOD_EXIF_IFD = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_FILE_SOURCE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_SCENE_TYPE = new TagInfo2(
			"Scene Type", 0xa301, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_CFAPATTERN = new TagInfo2(
			"CFAPattern", 0xa302, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_CUSTOM_RENDERED = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_EXPOSURE_MODE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_WHITE_BALANCE_1 = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_DIGITAL_ZOOM_RATIO = new TagInfo2(
			"Digital Zoom Ratio", 0xa404, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_FOCAL_LENGTH_IN_35MM_FORMAT = new TagInfo2(
			"Focal Length In 3 5mm Format", 0xa405, FIELD_TYPE_SHORT, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SCENE_CAPTURE_TYPE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_GAIN_CONTROL = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_CONTRAST_1 = new TagInfo2("Contrast",
	...
	public static final TagInfo2 EXIF_TAG_SATURATION_1 = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_SHARPNESS_1 = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_DEVICE_SETTING_DESCRIPTION = new TagInfo2(
			"Device Setting Description", 0xa40b,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_SUBJECT_DISTANCE_RANGE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_IMAGE_UNIQUE_ID = new TagInfo2(
			"Image Unique ID", 0xa420, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_GDALMETADATA = new TagInfo2(
			"GDALMetadata", 0xa480, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_GDALNO_DATA = new TagInfo2(
			"GDALNo Data", 0xa481, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_GAMMA = new TagInfo2("Gamma", 0xa500,
			FIELD_TYPE_RATIONAL, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_PIXEL_FORMAT = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_TRANSFOMATION = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_UNCOMPRESSED = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_IMAGE_TYPE = new TagInfo2(
			"Image Type", 0xbc04, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_WIDTH = new TagInfo2(
			"Image Width", 0xbc80, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_HEIGHT = new TagInfo2(
			"Image Height", 0xbc81, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_WIDTH_RESOLUTION = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_ALPHA_OFFSET = new TagInfo2(
			...
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_ALPHA_BYTE_COUNT = new TagInfo2(
			"Alpha Byte Count", 0xbcc3, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_IMAGE_DATA_DISCARD = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_ALPHA_DATA_DISCARD = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_OCE_SCANJOB_DESC = new TagInfo2(
			"Oce Scanjob Desc", 0xc427, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_OCE_APPLICATION_SELECTOR = new TagInfo2(
			"Oce Application Selector", 0xc428, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_OCE_IDNUMBER = new TagInfo2(
			"Oce IDNumber", 0xc429, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_OCE_IMAGE_LOGIC = new TagInfo2(
			"Oce Image Logic", 0xc42a, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_ANNOTATIONS = new TagInfo2(
			"Annotations", 0xc44f, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_PRINT_IM = new TagInfo2("Print IM",
			0xc4a5, FIELD_TYPE_UNDEFINED, 1, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_DNG_VERSION = new TagInfo2(
			"DNG Version", 0xc612, FIELD_TYPE_BYTE, 4, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_DNG_BACKWARD_VERSION = new TagInfo2(
			"DNG Backward Version", 0xc613, FIELD_TYPE_BYTE, 4,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_UNIQUE_CAMERA_MODEL = new TagInfo2(
			"Unique Camera Model", 0xc614, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_LOCALIZED_CAMERA_MODEL = new TagInfo2(
			"Localized Camera Model", 0xc615, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_CFAPLANE_COLOR = new TagInfo2(
			"CFAPlane Color", 0xc616, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CFALAYOUT = new TagInfo2("CFALayout",
	...
	public static final TagInfo2 EXIF_TAG_LINEARIZATION_TABLE = new TagInfo2(
			"Linearization Table", 0xc618, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BLACK_LEVEL_REPEAT_DIM = new TagInfo2(
			"Black Level Repeat Dim", 0xc619, FIELD_TYPE_DESCRIPTION_UNKNOWN,
			1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BLACK_LEVEL = new TagInfo2(
			"Black Level", 0xc61a, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BLACK_LEVEL_DELTA_H = new TagInfo2(
			"Black Level Delta H", 0xc61b, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_BLACK_LEVEL_DELTA_V = new TagInfo2(
			"Black Level Delta V", 0xc61c, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_WHITE_LEVEL = new TagInfo2(
			"White Level", 0xc61d, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_DEFAULT_SCALE = new TagInfo2(
			"Default Scale", 0xc61e, FIELD_TYPE_RATIONAL, 2,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_DEFAULT_CROP_ORIGIN = new TagInfo2(
			"Default Crop Origin", 0xc61f, FIELD_TYPE_LONG, 2,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_DEFAULT_CROP_SIZE = new TagInfo2(
			"Default Crop Size", 0xc620, FIELD_TYPE_LONG, 2,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_COLOR_MATRIX_1 = new TagInfo2(
			"Color Matrix 1", 0xc621, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_COLOR_MATRIX_2 = new TagInfo2(
			"Color Matrix 2", 0xc622, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CAMERA_CALIBRATION_1 = new TagInfo2(
			"Camera Calibration 1", 0xc623, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CAMERA_CALIBRATION_2 = new TagInfo2(
			"Camera Calibration 2", 0xc624, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_REDUCTION_MATRIX_1 = new TagInfo2(
			"Reduction Matrix 1", 0xc625, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_REDUCTION_MATRIX_2 = new TagInfo2(
			"Reduction Matrix 2", 0xc626, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_ANALOG_BALANCE = new TagInfo2(
			"Analog Balance", 0xc627, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_AS_SHOT_NEUTRAL = new TagInfo2(
			"As Shot Neutral", 0xc628, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_AS_SHOT_WHITE_XY = new TagInfo2(
			"As Shot White XY", 0xc629, FIELD_TYPE_RATIONAL, 2,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_BASELINE_EXPOSURE = new TagInfo2(
			"Baseline Exposure", 0xc62a, FIELD_TYPE_SRATIONAL, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_BASELINE_NOISE = new TagInfo2(
			"Baseline Noise", 0xc62b, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_BASELINE_SHARPNESS = new TagInfo2(
			"Baseline Sharpness", 0xc62c, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_BAYER_GREEN_SPLIT = new TagInfo2(
			"Bayer Green Split", 0xc62d, FIELD_TYPE_LONG, 1,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_LINEAR_RESPONSE_LIMIT = new TagInfo2(
			"Linear Response Limit", 0xc62e, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_CAMERA_SERIAL_NUMBER = new TagInfo2(
			"Camera Serial Number", 0xc62f, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_DNG_LENS_INFO = new TagInfo2(
			"DNG Lens Info", 0xc630, FIELD_TYPE_RATIONAL, 4, EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_CHROMA_BLUR_RADIUS = new TagInfo2(
			"Chroma Blur Radius", 0xc631, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_ANTI_ALIAS_STRENGTH = new TagInfo2(
			"Anti Alias Strength", 0xc632, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_SHADOW_SCALE = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_DNG_ADOBE_DATA = new TagInfo2(
			"DNG Adobe Data", 0xc634, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_DNG_PENTAX_DATA = new TagInfo2(
			"DNG Pentax Data", 0xc634, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_DNG_PRIVATE_DATA = new TagInfo2(
			"DNG Private Data", 0xc634, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_MAKER_NOTE_SAFETY = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_CALIBRATION_ILLUMINANT_1 = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_CALIBRATION_ILLUMINANT_2 = new TagInfo2(
	...
	public static final TagInfo2 EXIF_TAG_BEST_QUALITY_SCALE = new TagInfo2(
			"Best Quality Scale", 0xc65c, FIELD_TYPE_RATIONAL, 1,
			EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_RAW_DATA_UNIQUE_ID = new TagInfo2(
			"Raw Data Unique ID", 0xc65d, FIELD_TYPE_BYTE, 16,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_ALIAS_LAYER_METADATA = new TagInfo2(
			"Alias Layer Metadata", 0xc660, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_ORIGINAL_RAW_FILE_NAME = new TagInfo2(
			"Original Raw File Name", 0xc68b, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_ORIGINAL_RAW_FILE_DATA = new TagInfo2(
			"Original Raw File Data", 0xc68c, FIELD_TYPE_UNDEFINED, 1,
			EXIF_DIRECTORY_IFD0);
	public static final TagInfo2 EXIF_TAG_ACTIVE_AREA = new TagInfo2(
			"Active Area", 0xc68d, FIELD_TYPE_LONG, 4, EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_MASKED_AREAS = new TagInfo2(
			"Masked Areas", 0xc68e, FIELD_TYPE_LONG, 4, EXIF_DIRECTORY_SUB_IFD);
	public static final TagInfo2 EXIF_TAG_AS_SHOT_ICCPROFILE = new TagInfo2(
			"As Shot ICCProfile", 0xc68f, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_AS_SHOT_PRE_PROFILE_MATRIX = new TagInfo2(
			"As Shot Pre Profile Matrix", 0xc690,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CURRENT_ICCPROFILE = new TagInfo2(
			"Current ICCProfile", 0xc691, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1,
			EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_CURRENT_PRE_PROFILE_MATRIX = new TagInfo2(
			"Current Pre Profile Matrix", 0xc692,
			FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
	public static final TagInfo2 EXIF_TAG_OFFSET_SCHEMA = new TagInfo2(
			"Offset Schema", 0xea1d, FIELD_TYPE_SLONG, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_OWNER_NAME = new TagInfo2(
			"Owner Name", 0xfde8, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SERIAL_NUMBER = new TagInfo2(
			"Serial Number", 0xfde9, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_LENS = new TagInfo2("Lens", 0xfdea,
			FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_RAW_FILE = new TagInfo2("Raw File",
			0xfe4c, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_CONVERTER = new TagInfo2("Converter",
			0xfe4d, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_WHITE_BALANCE_2 = new TagInfo2(
			"White Balance", 0xfe4e, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_EXPOSURE = new TagInfo2("Exposure",
			0xfe51, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SHADOWS = new TagInfo2("Shadows",
			0xfe52, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_BRIGHTNESS = new TagInfo2(
			"Brightness", 0xfe53, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_CONTRAST_2 = new TagInfo2("Contrast",
			0xfe54, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SATURATION_2 = new TagInfo2(
			"Saturation", 0xfe55, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SHARPNESS_2 = new TagInfo2(
			"Sharpness", 0xfe56, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_SMOOTHNESS = new TagInfo2(
			"Smoothness", 0xfe57, FIELD_TYPE_ASCII, 1, EXIF_DIRECTORY_EXIF_IFD);
	public static final TagInfo2 EXIF_TAG_MOIRE_FILTER = new TagInfo2(
			"Moire Filter", 0xfe58, FIELD_TYPE_ASCII, 1,
			EXIF_DIRECTORY_EXIF_IFD);

	public static final TagInfo2 ALL_EXIF_TAGS[] = {
