...
enum IcnsType {
    ...
    ICNS_16x16_32BIT_ARGB_IMAGE("icp4", 16, 16, 32, false, true),

    ICNS_32x32_1BIT_MONO_IMAGE("ICON", 32, 32, 1, false, false),
    ...
    ICNS_32x32_32BIT_IMAGE("il32", 32, 32, 32, false, false),
    ICNS_32x32_8BIT_MASK("l8mk", 32, 32, 8, true, false),
    ICNS_32x32_32BIT_ARGB_IMAGE("icp5", 32, 32, 32, false, true),
    ICNS_16x16_32BIT_RETINA_IMAGE("ic11", 32, 32, 32, false, true),

    ICNS_48x48_1BIT_MASK("ich#", 48, 48, 1, true, false),
    ICNS_48x48_4BIT_IMAGE("ich4", 48, 48, 4, false, false),
    ICNS_48x48_8BIT_IMAGE("ich8", 48, 48, 8, false, false),
    ICNS_48x48_32BIT_IMAGE("ih32", 48, 48, 32, false, false),
    ICNS_48x48_8BIT_MASK("h8mk", 48, 48, 8, true, false),

    ICNS_64x64_32BIT_ARGB_IMAGE("icp6", 64, 64, 32, false, true),
    ICNS_32x32_32BIT_RETINA_IMAGE("ic12", 64, 64, 32, false, true),

    ICNS_128x128_32BIT_IMAGE("it32", 128, 128, 32, false, false),
    ICNS_128x128_8BIT_MASK("t8mk", 128, 128, 8, true, false),
    ICNS_128x128_32BIT_ARGB_IMAGE("ic07", 128, 128, 32, false, true),

    ICNS_256x256_32BIT_ARGB_IMAGE("ic08", 256, 256, 32, false, true),
    ICNS_128x128_32BIT_RETINA_IMAGE("ic13", 256, 256, 32, false, true),

    ICNS_512x512_32BIT_ARGB_IMAGE("ic09", 512, 512, 32, false, true),
    ICNS_256x256_32BIT_RETINA_IMAGE("ic14", 512, 512, 32, false, true),
