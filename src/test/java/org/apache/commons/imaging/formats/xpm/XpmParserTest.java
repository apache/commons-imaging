...
public class XpmParserTest {
    ...
    public void testPaletteEntry() throws Exception {
        ...
        final Method getBestArgbMethod = entryClass.getDeclaredMethod("getBestArgb");
        ...
        final Field gray4LevelArgbField = entryClass.getDeclaredField("gray4LevelArgb");
        gray4LevelArgbField.setAccessible(true);
        final Field haveGray4LevelField = entryClass.getDeclaredField("haveGray4Level");
