...
public class PixelParserBitFieldsTest {
    ...
    public void testGetNextRgb_16Bit() throws IOException {
        ...
        final BmpHeaderInfo bhi = new BmpHeaderInfo(
            (byte) 0, (byte) 0, 0, 0, 0, 0, 1, 1, 1, 16, 3, 0, 0, 0, 0, 0,
    ...
    public void testGetNextRgb_32Bit_WithAlpha() throws IOException {
        final BmpHeaderInfo bhi = new BmpHeaderInfo(
            (byte) 0, (byte) 0, 0, 0, 0, 0, 1, 1, 1, 32, 3, 0, 0, 0, 0, 0,
            0x00FF0000, // red
            0x0000FF00, // green
            0x000000FF, // blue
            0xFF000000, // alpha
    ...
    public void testGetNextRgb_24Bit() throws IOException {
        final BmpHeaderInfo bhi = new BmpHeaderInfo(
            (byte) 0, (byte) 0, 0, 0, 0, 0, 1, 1, 1, 24, 3, 0, 0, 0, 0, 0,
            0x00FF0000, // red
            0x0000FF00, // green
            0x000000FF, // blue
            0, // alpha
    ...
    public void testGetNextRgb_8Bit() throws IOException {
        final BmpHeaderInfo bhi = new BmpHeaderInfo(
            (byte) 0, (byte) 0, 0, 0, 0, 0, 1, 1, 1, 8, 3, 0, 0, 0, 0, 0,
            0b11100000, // red
            0b00011100, // green
            0b00000011, // blue
            0, // alpha
    ...
    public void testNewlinePadding() throws IOException {
        final BmpHeaderInfo bhi = new BmpHeaderInfo(
            (byte) 0, (byte) 0, 0, 0, 0, 0, 1, 1, 1, 16, 3, 0, 0, 0, 0, 0,
            0xF800, 0x07E0, 0x001F, 0, 0, null, 0, 0, 0, 0, 0, 0, 0
        );
    ...
    public void testUnknownBitsPerPixel() {
        final BmpHeaderInfo bhi = new BmpHeaderInfo(
            (byte) 0, (byte) 0, 0, 0, 0, 0, 1, 1, 1, 7, 3, 0, 0, 0, 0, 0,
